...
il_awac_beta = 1.0
il_awac_clip = 5.0
il_qfilter_delta = 0.0
il_use_qfilter = True
dagger_entropy_threshold = 1.0
dagger_confidence_gap = 0.1
dagger_value_threshold = -1.0
dagger_label_interval = 5
dagger_label_stride = 3
dagger_rollout_horizon = 64
dagger_max_labels = 96
dagger_base_ratio = 0.1
dagger_min_ratio = 0.05
dagger_max_ratio = 0.2
dagger_online_ratio = 0.6
dagger_demo_ratio = 0.3
dagger_interval_growth = 1.5
dagger_interval_shrink = 1.2
dagger_interval_multiplier_max = 6.0
dagger_qfilter_cooldown = 0.2
dagger_kl_cooldown = 0.05
stop_iters = 6
